...
const Home = () => {
    ...
    useEffect(() => {
        let url=`https://api.themoviedb.org/3/movie/popular?page=${page}&api_key=bc317856d2dce2804d8a3f472034381a`
        if(search){
            url=`https://api.themoviedb.org/3/search/movie?query=${search}&api_key=bc317856d2dce2804d8a3f472034381a`
        }
        fetch(url)
        .then((res) => res.json())
